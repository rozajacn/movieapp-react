...
const EditMovie = () => {
    ...
    document.title = "Edit Movie | MoviesApp";
    return (
        <div>
            <React.Fragment>
                    ...
                    <div className="d-flex justify-content-center">
                        <Formik
                            initialValues={{
                                ...
                                writers: location.state.writers,
                                genre: location.state.genre,
                                rating: location.state.rating,
                                releaseYear: location.state.releaseYear,
                                description: location.state.description,
                            }}
                            onSubmit={(values, { setSubmitting }) => {
                                setTimeout(() => {
                                    service.editMovie(values)
                                        .then(function (response: any) {
                                            navigate('/details-movie', { state: location.state.id });
                                            toast.success(`You have update movie ${values.title}!`);
                                        })
                                    ...
                                    <div className="d-flex flex-row-reverse py-3">
                                        ...
                                        <div className="p-1">
                                            <button
                                                ...
                                                onClick={() => navigate("/details-movie", { state: location.state.id })}>
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
